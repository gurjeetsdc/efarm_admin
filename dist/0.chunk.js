...
var list_equipment_component_1 = __webpack_require__(1435);
var view_equipment_component_1 = __webpack_require__(1436);
var addupdate_equipment_component_1 = __webpack_require__(1434);
var equipments_routing_module_1 = __webpack_require__(1461);
var ng2_datepicker_1 = __webpack_require__(1409);
var googleplaces_directive_1 = __webpack_require__(1466);
var ngx_flash_messages_1 = __webpack_require__(711);
var shared_module_1 = __webpack_require__(1406);
var ng2_bootstrap_modal_1 = __webpack_require__(712);
var promptEquipmentCategory_component_1 = __webpack_require__(1447);
var promptEquipmentManufacturer_component_1 = __webpack_require__(1448);
var EquipmentsModule = (function () {
...
EquipmentsModule = __decorate([
    core_1.NgModule({
        imports: [
            equipments_routing_module_1.EquipmentsRoutingModule,
        ...
        declarations: [
            ...
            googleplaces_directive_1.GoogleplaceDirective,
            promptEquipmentCategory_component_1.PromptEquipmentCategoryComponent,
            promptEquipmentManufacturer_component_1.PromptEquipmentManufacturerComponent
        ],
...
//# sourceMappingURL=/home/manpreets/Documents/office/efarm/efarm_admin/src/equipments.module.js.map
...
var CategoryService = (function () {
    function CategoryService(_http, _commanService) {
        this._http = _http;
    ...
    CategoryService.prototype.getAllCategory = function (rowsOnPage, activePage, sortTrem, search) {
        if (search === void 0) { search = ''; }
        var headers = new http_1.Headers();
        this._accessToken = this._commanService.getAccessToken();
        var url = this._host + '/allcategory?count=' + rowsOnPage + '&page=' + activePage + '&sortBy=' + sortTrem + '&search=' + search;
        ;
    ...
    CategoryService.prototype.add = function (category) {
        ...
        this._accessToken = this._commanService.getAccessToken();
        headers.append('Authorization', this._accessToken);
        return this._http.post(this._host + '/category', category, { headers: headers }).map(function (res) { return res.json(); });
    };
    ...
    CategoryService.prototype.get = function (ID) {
        ...
        this._accessToken = this._commanService.getAccessToken();
        headers.append('Authorization', this._accessToken);
        return this._http.get(this._host + '/category/' + ID, { headers: headers }).map(function (res) { return res.json(); });
    };
    /*Use to update input*/
    CategoryService.prototype.update = function (category) {
        ...
        this._accessToken = this._commanService.getAccessToken();
        headers.append('Authorization', this._accessToken);
        return this._http.put(this._host + '/category/' + category.id, category, { headers: headers }).map(function (res) { return res.json(); });
    };
    ...
    CategoryService.prototype.delete = function (Id) {
        ...
        this._accessToken = this._commanService.getAccessToken();
        headers.append('Authorization', this._accessToken);
        return this._http.delete(this._host + '/category/' + Id, { headers: headers }).map(function (res) { return res.json(); });
    };
...
var _a, _b;
//# sourceMappingURL=/home/manpreets/Documents/office/efarm/efarm_admin/src/category.service.js.map
...
var ManufacturerService = (function () {
    function ManufacturerService(_http, _commanService) {
        this._http = _http;
        this._commanService = _commanService;
        this._host = tsConstants.HOST;
        this._accessToken = '';
    ...
    ManufacturerService.prototype.getAllManufacturer = function (rowsOnPage, activePage, sortTrem, search) {
        if (search === void 0) { search = ''; }
        var headers = new http_1.Headers();
        this._accessToken = this._commanService.getAccessToken();
        var url = this._host + '/allmanufacturer?count=' + rowsOnPage + '&page=' + activePage + '&sortBy=' + sortTrem + '&search=' + search;
        headers.append('Authorization', this._accessToken);
        return this._http.get(url, { headers: headers }).map(function (res) { return res.json(); });
    };
    /*Use to add new manufacturer*/
    ManufacturerService.prototype.add = function (manufacturer) {
        var headers = new http_1.Headers();
        this._accessToken = this._commanService.getAccessToken();
        headers.append('Authorization', this._accessToken);
        return this._http.post(this._host + '/manufacturer', manufacturer, { headers: headers }).map(function (res) { return res.json(); });
    };
    /*Use to get manufacturer with manufacturer id*/
    ManufacturerService.prototype.get = function (manufacturerID) {
        var headers = new http_1.Headers();
        this._accessToken = this._commanService.getAccessToken();
        headers.append('Authorization', this._accessToken);
        return this._http.get(this._host + '/manufacturer/' + manufacturerID, { headers: headers }).map(function (res) { return res.json(); });
    };
    ...
    ManufacturerService.prototype.update = function (manufacturer) {
        ...
        this._accessToken = this._commanService.getAccessToken();
        headers.append('Authorization', this._accessToken);
        return this._http.put(this._host + '/manufacturer/' + manufacturer.id, manufacturer, { headers: headers }).map(function (res) { return res.json(); });
    };
    /*Use to Delete manufacturer with manufacturer id */
    ManufacturerService.prototype.delete = function (manufacturerID) {
        var headers = new http_1.Headers();
        this._accessToken = this._commanService.getAccessToken();
        headers.append('Authorization', this._accessToken);
        return this._http.delete(this._host + '/manufacturer/' + manufacturerID, { headers: headers }).map(function (res) { return res.json(); });
    };
...
var _a, _b;
//# sourceMappingURL=/home/manpreets/Documents/office/efarm/efarm_admin/src/manufacturer.service.js.map
...
module.exports = "<!-- Category Prompte Component this is -->\n\n<div class=\"modal-dialog\">\n                <div class=\"modal-content\">\n\n                   <div class=\"modal-header\">\n                     <h4 class=\"modal-title\">{{title || 'Prompt'}}</h4>\n                     <button type=\"button\" class=\"close\" (click)=\"close()\">&times;</button>\n                   </div>\n\n                   <div class=\"modal-body\">\n            <!--Form components-->\n            \n                      <div class=\"card-block\">\n\n                <div class=\"row\">\n                    <div class=\"col-sm-12\">\n                        <div class=\"form-group  has-required\">\n                            \n                            <label for=\"nf-name\">Name</label>\n                            <input autofocus=\"\" type=\"text\" id=\"name\" name=\"name\" class=\"form-control\"  [(ngModel)]=\"catg.name\" pattern=\"[a-zA-Z][a-zA-Z0-9!@#$%^&*()\\s]*\" required>\n                            <div class=\"error-block\">\n                                <small *ngIf=\"nameErr != ''\" class=\"text-danger\">\n                                    {{nameErr}}\n                                </small>                                                          \n                            </div>\n                        </div>\n                    </div>\n                    \n                </div>\n                <div class=\"row\">\n                    <div class=\"col-sm-12\">\n                        <div class=\"form-group relative\">\n                            <label for=\"nf-name\">Variety</label>\n                            <input type=\"text\" id=\"vname\" name=\"vname\"(ngModelChange)=\"message='';\" class=\"form-control wdthset\" [(ngModel)]=\"oBj.vname\">\n                            \n                            <i (click)=\"addEelement()\" title=\"Add Variety\" class=\"fa fa-plus addimage\"></i>\n                            <div class=\"error-block\">\n                                <small *ngIf=\"message != ''\" class=\"text-danger\">\n                                    {{message}}\n                                </small>                                                          \n                            </div>\n                            <div class=\"block\">\n                                <div class=\"chip\" *ngFor=\"let rcd of catg.variety; let i=index\">\n                                    <div class=\"chip\">{{rcd}}\n                                        <i class=\"close fa fa-times\" (click)=\"removeEelement(i)\"></i>\n                                    </div>\n                                </div>\n                            </div>\n                        </div>\n                    </div>\n\n                </div>\n          \n            <!---Form Components-->\n                   </div>\n\n                   <div class=\"modal-footer\">\n                     <button type=\"button\" class=\"btn btn-success\" (click)=\"apply()\">Save</button>\n                     <button type=\"button\" class=\"btn btn-default\" (click)=\"close()\" >Cancel</button>\n                   </div>\n\n                 </div>\n</div>"
...
var EquipmentService = (function () {
    function EquipmentService(_http, _commanService) {
        this._http = _http;
        this._commanService = _commanService;
        this._host = tsConstants.HOST;
        this._accessToken = '';
    }
    EquipmentService.prototype.getAllEquipments = function (rowsOnPage, activePage, sortTrem, search) {
        if (search === void 0) { search = ''; }
        var headers = new http_1.Headers();
        this._accessToken = this._commanService.getAccessToken();
        var url = this._host + '/equipment?count=' + rowsOnPage + '&page=' + activePage + '&sortBy=' + sortTrem + '&search=' + search;
        ;
        headers.append('Authorization', this._accessToken);
        return this._http.get(url, { headers: headers }).map(function (res) { return res.json(); });
    };
    EquipmentService.prototype.add = function (equipment) {
        var headers = new http_1.Headers();
        this._accessToken = this._commanService.getAccessToken();
        headers.append('Authorization', this._accessToken);
        return this._http.post(this._host + '/equipment', equipment, { headers: headers }).map(function (res) { return res.json(); });
    };
    /** get a single Equipment by ID **/
    EquipmentService.prototype.get = function (equipmentID) {
        var headers = new http_1.Headers();
        this._accessToken = this._commanService.getAccessToken();
        headers.append('Authorization', this._accessToken);
        return this._http.get(this._host + '/equipment/' + equipmentID, { headers: headers }).map(function (res) { return res.json(); });
    };
    /** update equipment **/
    EquipmentService.prototype.update = function (equipment) {
        var headers = new http_1.Headers();
        this._accessToken = this._commanService.getAccessToken();
        headers.append('Authorization', this._accessToken);
        return this._http.put(this._host + '/equipment/' + equipment.id, equipment, { headers: headers }).map(function (res) { return res.json(); });
    };
    /** DeleteID equipment by ID **/
    EquipmentService.prototype.delete = function (equipmentID) {
        var headers = new http_1.Headers();
        this._accessToken = this._commanService.getAccessToken();
        headers.append('Authorization', this._accessToken);
        return this._http.delete(this._host + '/equipment/' + equipmentID, { headers: headers }).map(function (res) { return res.json(); });
    };
    ...
    EquipmentService.prototype.getAllManufactures = function () {
        var headers = new http_1.Headers();
        this._accessToken = this._commanService.getAccessToken();
        headers.append('Authorization', this._accessToken);
...
module.exports = "<div class=\"modal-dialog\">\n\n                <div class=\"modal-content\">\n\n                   <div class=\"modal-header\">\n                     <h4 class=\"modal-title\">{{title || 'Prompt'}}</h4>\n                      <button type=\"button\" class=\"close\" (click)=\"close()\">&times;</button>\n\n                   </div>\n\n                   <div class=\"modal-body\">\n            <!--Form components-->\n                <div class=\"card-block\">\n\n                <div class=\"row\">\n                    <div class=\"col-sm-12\">\n                        <div class=\"form-group  has-required\">\n                            \n                             <label for=\"nf-name\">Name</label>\n                            <input type=\"text\" id=\"name\" name=\"name\" class=\"form-control\" [(ngModel)]=\"manufacturer.name\" required (ngModelChange)=\"nameErrors=''\">\n                            <div class=\"error-block\">\n                                <small *ngIf=\"nameErrors\" class=\"text-danger\">\n                                   {{nameErrors}}\n                                </small>\n                            </div> \n\n                        </div>\n                    </div>\n                    \n                </div>\n\n                <div class=\"row\">\n                    <div class=\"col-sm-12\">\n                        <div class=\"form-group\">\n                             <label for=\"nf-email\">Email</label>\n                            <input type=\"email\" id=\"email\" name=\"email\" class=\"form-control\" [(ngModel)]=\"manufacturer.email\" email (ngModelChange)=\"emailErrors=false\">\n                            <div class=\"error-block\">\n                                <small *ngIf=\"emailErrors\" class=\"text-danger\">\n                                   {{emailErrors}}\n                                </small>                                  \n                            </div>\n                        </div>\n                    </div>\n                </div>\n\n                <div class=\"row\">\n                    <div class=\"col-sm-12\">\n                        <div class=\"form-group\">\n                            <label for=\"nf-mobile\">Mobile</label>\n                            <input type=\"number\" id=\"mobile\" name=\"mobile\" class=\"form-control\" [(ngModel)]=\"manufacturer.mobile\"  min=\"1\" max=\"10\">\n                            <div class=\"error-block\">\n                                <small *ngIf=\"mobileErrors\" class=\"text-danger\">\n                                   {{mobileErrors}}\n                                </small>\n                            </div>\n                        </div>\n                    </div>\n                </div>\n\n                <div class=\"row\">\n                    <div class=\"col-sm-12\">\n                        <div class=\"form-group\">\n                            <label for=\"nf-description\">Description</label>\n                            <textarea type=\"text\" id=\"description\" name=\"description\" class=\"form-control\" [(ngModel)]=\"manufacturer.description\" placeholder=\"\" rows=\"4\"></textarea>\n                        </div>\n                    </div>\n                </div>\n\n                </div>\n          \n            <!---Form Components-->\n                   </div>\n                    <div class=\"modal-footer\">\n                     <button type=\"button\" class=\"btn btn-success\" (click)=\"apply()\">Save</button>\n                     <button type=\"button\" class=\"btn btn-default\" (click)=\"close()\" >Cancel</button>\n                  </div>\n                  \n                 </div>\n\n                 \n\n                </div>\n\n"
...
var promptEquipmentManufacturer_component_1 = __webpack_require__(1448);
var ng2_bootstrap_modal_1 = __webpack_require__(712);
var equipment_service_1 = __webpack_require__(1418);
var ngx_cookie_1 = __webpack_require__(90);
var AddUpdateEquipmentComponent = (function () {
    function AddUpdateEquipmentComponent(dialogService, _router, _activateRouter, _equipmentService, changeDetectorRef, _cookieService) {
        var _this = this;
        ...
        if (this.equipmentID) {
            this._equipmentService.get(this.equipmentID).subscribe(function (res) {
        ...
        this._equipmentService.getAllCategories().subscribe(function (res) {
        ...
        this._equipmentService.getAllUsers().subscribe(function (res) {
            _this.sellers = res.data.users;
        }, function (err) {
            _this.checkAccessToken(err);
        });
        this._equipmentService.getAllManufactures().subscribe(function (res) {
            _this.manufacturers = res.data;
        }, function (err) {
            _this.checkAccessToken(err);
        });
        this._equipmentService.getStates().subscribe(function (res) {
    ...
    AddUpdateEquipmentComponent.prototype.showCategoryPrompt = function () {
        var _this = this;
        this.dialogService.addDialog(promptEquipmentCategory_component_1.PromptEquipmentCategoryComponent, {
            title: 'Add Category',
            type: 'equipments',
            ...
            if (res) {
                var response = res;
                _this.category.push(response);
                _this.setCategoryInSelectBox(response);
            }
        });
    };
    AddUpdateEquipmentComponent.prototype.setCategoryInSelectBox = function (response) {
        this.equipment.category_id = response.id;
        this.setVarieties();
    };
    // Show add PromptEquipmentManufacturerComponent Prompt
    AddUpdateEquipmentComponent.prototype.showManufacturerPrompt = function () {
        var _this = this;
        this.dialogService.addDialog(promptEquipmentManufacturer_component_1.PromptEquipmentManufacturerComponent, {
            ...
            if (res) {
                var response = res;
                _this.manufacturers.push(response);
                _this.setInputManufacturer(response);
            }
        });
    };
    AddUpdateEquipmentComponent.prototype.setInputManufacturer = function (argu) {
    ...
    AddUpdateEquipmentComponent.prototype.setVarieties = function () {
        var _this = this;
        /* reset values. */
        this.varieties = null;
        if (this.action !== 'Edit') {
    ...
    AddUpdateEquipmentComponent.prototype.setDistrict = function () {
        ...
        /* Initialize category. */
        var stateName = this.equipment.state;
        if (stateName) {
    ...
    AddUpdateEquipmentComponent.prototype.addEquipment = function () {
        ...
        this._equipmentService.add(this.equipment).subscribe(function (res) {
            _this.response = res;
            _this.showMessage = true;
            // this.equipment   = {};
            _this._cookieService.put('equipmentAlert', 'Added successfully.');
            _this.clearEquipment();
            _this._router.navigate(['/equipments/list', { data: "success" }]);
        }, function (err) {
            _this.checkAccessToken(err);
        });
    };
    AddUpdateEquipmentComponent.prototype.editEquipment = function () {
        ...
        this.equipment.user = this.equipment.user_id;
        this.equipment.companyManufacturer = this.equipment.companyManufacturer_id;
        this._equipmentService.update(this.equipment).subscribe(function (res) {
            _this.response = res;
            _this.showMessage = true;
            _this._cookieService.put('equipmentAlert', 'Updated successfully.');
            _this.clearEquipment();
            _this._router.navigate(['/equipments/list', { data: "success" }]);
        }, function (err) {
            _this.checkAccessToken(err);
    ...
    AddUpdateEquipmentComponent.prototype.checkAccessToken = function (err) {
        var code = err.code;
        var message = err.message;
        if ((code == 401 && message == "authorization")) {
            this._cookieService.removeAll();
...
AddUpdateEquipmentComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof ng2_bootstrap_modal_1.DialogService !== "undefined" && ng2_bootstrap_modal_1.DialogService) === "function" && _a || Object, typeof (_b = typeof router_1.Router !== "undefined" && router_1.Router) === "function" && _b || Object, typeof (_c = typeof router_1.ActivatedRoute !== "undefined" && router_1.ActivatedRoute) === "function" && _c || Object, typeof (_d = typeof equipment_service_1.EquipmentService !== "undefined" && equipment_service_1.EquipmentService) === "function" && _d || Object, typeof (_e = typeof core_1.ChangeDetectorRef !== "undefined" && core_1.ChangeDetectorRef) === "function" && _e || Object, typeof (_f = typeof ngx_cookie_1.CookieService !== "undefined" && ngx_cookie_1.CookieService) === "function" && _f || Object])
...
var router_1 = __webpack_require__(75);
var equipment_service_1 = __webpack_require__(1418);
var Angular2_csv_1 = __webpack_require__(1410);
var ngx_flash_messages_1 = __webpack_require__(711);
var ngx_cookie_1 = __webpack_require__(90);
var comman_service_1 = __webpack_require__(1392);
var ListEquipmentComponent = (function () {
    function ListEquipmentComponent(activatedRouter, _router, _equipmentService, _flashMessagesService, _cookieService, _commanService) {
    ...
    ListEquipmentComponent.prototype.removeEquipment = function (equipmentID) {
        ...
        if (confirm("Do you want to delete?")) {
            this.isLoading = true;
            this._equipmentService.delete(equipmentID).subscribe(function (res) {
                _this.response = res;
                _this.isLoading = false;
                ...
                _this._cookieService.put('equipmentAlert', 'Deleted successfully.');
                /* reload page. */
                _this.getEquipments();
            });
        }
    ...
    ListEquipmentComponent.prototype.checkAccessToken = function (err) {
        var code = err.code;
        var message = err.message;
        if ((code == 401 && message == "authorization")) {
            this._cookieService.removeAll();
    ...
    /*get all equipments*/
    ListEquipmentComponent.prototype.getEquipments = function () {
        var _this = this;
        this._equipmentService.getAllEquipments(this.rowsOnPage, this.activePage, this.sortTrem, this.searchTerm).subscribe(function (res) {
            _this.isLoading = false;
            _this.isPageLoading = false;
            if (res.success) {
                _this.data = res.data.equipments;
            ...
            _this._commanService.checkAccessToken(err);
            _this.isLoading = false;
            _this.isPageLoading = false;
        });
    };
    /**/
    ListEquipmentComponent.prototype.onPageChange = function (event) {
        this.isLoading = true;
        this.rowsOnPage = event.rowsOnPage;
        this.activePage = event.activePage;
        this.getEquipments();
    };
    ListEquipmentComponent.prototype.onRowsChange = function (event) {
        this.isLoading = true;
        this.rowsOnPage = this.itemsOnPage;
        this.activePage = 1;
        this.getEquipments();
    };
    ListEquipmentComponent.prototype.onSortOrder = function (event) {
        this.sortTrem = this.sortBy + ' ' + this.sortOrder;
        this.isLoading = true;
        this.getEquipments();
    };
    ListEquipmentComponent.prototype.searchEquipment = function (event, element) {
    ...
    ListEquipmentComponent.prototype.downloadCSV = function () {
        var i;
        var filteredData = [];
        var header = {
            name: "Name",
        ...
        var fileName = "EquipmentReport-" + Math.floor(Date.now() / 1000);
        new Angular2_csv_1.Angular2Csv(filteredData, fileName);
    };
    ListEquipmentComponent.prototype.downloadPDF = function () {
        var i;
        var filteredData = [];
        var header = [
            "Name",
        ...
        var fileName = "EquipmentReport-" + Math.floor(Date.now() / 1000) + ".pdf";
        var doc = new jsPDF();
        // doc.setFontSize(10);
        // doc.setFontSize(12);
    ...
    ListEquipmentComponent.prototype.showAlert = function () {
        var alertMessage = this._cookieService.get('equipmentAlert');
        if (alertMessage) {
...
ListEquipmentComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof router_1.ActivatedRoute !== "undefined" && router_1.ActivatedRoute) === "function" && _a || Object, typeof (_b = typeof router_1.Router !== "undefined" && router_1.Router) === "function" && _b || Object, typeof (_c = typeof equipment_service_1.EquipmentService !== "undefined" && equipment_service_1.EquipmentService) === "function" && _c || Object, typeof (_d = typeof ngx_flash_messages_1.FlashMessagesService !== "undefined" && ngx_flash_messages_1.FlashMessagesService) === "function" && _d || Object, typeof (_e = typeof ngx_cookie_1.CookieService !== "undefined" && ngx_cookie_1.CookieService) === "function" && _e || Object, typeof (_f = typeof comman_service_1.CommanService !== "undefined" && comman_service_1.CommanService) === "function" && _f || Object])
...
var ViewEquipmentComponent = (function () {
    function ViewEquipmentComponent(_router, _activatedRouter, _equipmentService, _cookieService) {
        var _this = this;
        this._router = _router;
    ...
    ViewEquipmentComponent.prototype.checkAccessToken = function (err) {
        var code = err.code;
        var message = err.message;
        if ((code == 401 && message == "authorization")) {
            this._cookieService.removeAll();
...
var core_1 = __webpack_require__(0);
var ng2_bootstrap_modal_1 = __webpack_require__(712);
var category_service_1 = __webpack_require__(1411);
var PromptEquipmentCategoryComponent = (function (_super) {
    __extends(PromptEquipmentCategoryComponent, _super);
    function PromptEquipmentCategoryComponent(dialogService, _catgService) {
        var _this = _super.call(this, dialogService) || this;
        _this._catgService = _catgService;
        _this.message = '';
        _this.nameErr = '';
        _this.name = '';
        _this.catg = { name: '', variety: [] };
        _this.oBj = { vname: '' };
        return _this;
    }
    PromptEquipmentCategoryComponent.prototype.apply = function () {
        var _this = this;
        if (this.catg.name == '') {
        ...
        this._catgService.add(this.catg).subscribe(function (res) {
            _this.result = res;
            _this.close();
        }, function (err) {
    ...
    PromptEquipmentCategoryComponent.prototype.addEelement = function () {
        if (!this.oBj.vname) {
            this.message = "Variety is required.";
            return false;
        }
        var index = this.catg.variety.indexOf(this.oBj.vname);
        if (index >= 0) {
    ...
    PromptEquipmentCategoryComponent.prototype.removeEelement = function (index) {
        this.catg.variety.splice(index, 1);
    };
    return PromptEquipmentCategoryComponent;
}(ng2_bootstrap_modal_1.DialogComponent));
PromptEquipmentCategoryComponent = __decorate([
    core_1.Component({
        selector: 'prompt',
        template: __webpack_require__(1415),
        providers: [category_service_1.CategoryService]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof ng2_bootstrap_modal_1.DialogService !== "undefined" && ng2_bootstrap_modal_1.DialogService) === "function" && _a || Object, typeof (_b = typeof category_service_1.CategoryService !== "undefined" && category_service_1.CategoryService) === "function" && _b || Object])
], PromptEquipmentCategoryComponent);
exports.PromptEquipmentCategoryComponent = PromptEquipmentCategoryComponent;
var _a, _b;
//# sourceMappingURL=/home/manpreets/Documents/office/efarm/efarm_admin/src/promptEquipmentCategory.component.js.map
...
var core_1 = __webpack_require__(0);
var ng2_bootstrap_modal_1 = __webpack_require__(712);
var manufacturer_service_1 = __webpack_require__(1414);
var PromptEquipmentManufacturerComponent = (function (_super) {
    __extends(PromptEquipmentManufacturerComponent, _super);
    function PromptEquipmentManufacturerComponent(dialogService, _manufacturerService) {
        var _this = _super.call(this, dialogService) || this;
        _this._manufacturerService = _manufacturerService;
        _this.nameErrors = '';
        _this.emailErrors = '';
        _this.mobileErrors = '';
        _this.manufacturer = {
    ...
    PromptEquipmentManufacturerComponent.prototype.apply = function () {
        var _this = this;
        ...
        this._manufacturerService.add(this.manufacturer).subscribe(function (res) {
            _this.result = res;
            _this.close();
        }, function (err) {
            console.log("Server Error!");
            ...
            if (errBody.invalidAttributes.email) {
                _this.emailErrors = 'Email is not valid.';
            }
            if (errBody.invalidAttributes.mobile) {
                _this.mobileErrors = 'Mobile is not vaild';
            }
            return false;
        });
    };
    return PromptEquipmentManufacturerComponent;
}(ng2_bootstrap_modal_1.DialogComponent));
PromptEquipmentManufacturerComponent = __decorate([
    core_1.Component({
        selector: 'prompt',
        template: __webpack_require__(1423),
        providers: [manufacturer_service_1.ManufacturerService]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof ng2_bootstrap_modal_1.DialogService !== "undefined" && ng2_bootstrap_modal_1.DialogService) === "function" && _a || Object, typeof (_b = typeof manufacturer_service_1.ManufacturerService !== "undefined" && manufacturer_service_1.ManufacturerService) === "function" && _b || Object])
], PromptEquipmentManufacturerComponent);
exports.PromptEquipmentManufacturerComponent = PromptEquipmentManufacturerComponent;
var _a, _b;
//# sourceMappingURL=/home/manpreets/Documents/office/efarm/efarm_admin/src/promptEquipmentManufacturer.component.js.map
...
var EquipmentsRoutingModule = (function () {
...
exports.EquipmentsRoutingModule = EquipmentsRoutingModule;
//# sourceMappingURL=/home/manpreets/Documents/office/efarm/efarm_admin/src/equipments-routing.module.js.map
...
GoogleplaceDirective = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_e = typeof core_1.ElementRef !== "undefined" && core_1.ElementRef) === "function" && _e || Object, typeof (_f = typeof forms_1.NgModel !== "undefined" && forms_1.NgModel) === "function" && _f || Object])
], GoogleplaceDirective);
exports.GoogleplaceDirective = GoogleplaceDirective;
var _a, _b, _c, _d, _e, _f;
//# sourceMappingURL=/home/manpreets/Documents/office/efarm/efarm_admin/src/googleplaces.directive.js.map
