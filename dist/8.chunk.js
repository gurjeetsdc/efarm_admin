...
var list_category_component_1 = __webpack_require__(1426);
var addupdate_category_component_1 = __webpack_require__(1425);
var view_category_component_1 = __webpack_require__(1427);
var category_routing_module_1 = __webpack_require__(1452);
...
CategoryModule = __decorate([
    core_1.NgModule({
        ...
        declarations: [
            list_category_component_1.ListCategoryComponent,
            addupdate_category_component_1.AddUpdateCategoryComponent,
            view_category_component_1.ViewCategoryComponent
        ]
    })
], CategoryModule);
exports.CategoryModule = CategoryModule;
//# sourceMappingURL=/var/www/node_projects/angular2/efarm_admin/src/category.module.js.map
...
var ngx_cookie_1 = __webpack_require__(90);
var comman_service_1 = __webpack_require__(1396);
var AddUpdateCategoryComponent = (function () {
    function AddUpdateCategoryComponent(_router, _activateRouter, _catgService, _cookieService, _commanService, changeDetectorRef) {
        var _this = this;
        this._router = _router;
        this._activateRouter = _activateRouter;
        this._catgService = _catgService;
        this._cookieService = _cookieService;
        this._commanService = _commanService;
        ...
        if (this.categoryID) {
            this._catgService.get(this.categoryID).subscribe(function (res) {
    ...
    AddUpdateCategoryComponent.prototype.save = function () {
        var _this = this;
        this.isLoading = true;
        if (this.categoryID) {
            this._catgService.update(this.category).subscribe(function (res) {
                _this.response = res;
                _this.isLoading = false;
                _this._cookieService.put('categoryAlert', 'Updated successfully.');
                _this._router.navigate(['/category/list']);
            }, function (err) {
                _this.isLoading = false;
            });
        }
        else {
            this._catgService.add(this.category).subscribe(function (res) {
                _this.response = res;
                _this.isLoading = false;
                _this._cookieService.put('categoryAlert', 'Added successfully.');
                _this._router.navigate(['/category/list']);
            }, function (err) {
                _this.isLoading = false;
            });
    ...
    AddUpdateCategoryComponent.prototype.addEelement = function () {
        if (!this.oBj.vname) {
            this.errMessage = "Variety is required.";
            return false;
        }
        var index = this.category.variety.indexOf(this.oBj.vname);
        if (index >= 0) {
    ...
    AddUpdateCategoryComponent.prototype.removeEelement = function (index) {
        this.category.variety.splice(index, 1);
    };
    return AddUpdateCategoryComponent;
}());
AddUpdateCategoryComponent = __decorate([
    core_1.Component({
        template: __webpack_require__(1474)
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof router_1.Router !== "undefined" && router_1.Router) === "function" && _a || Object, typeof (_b = typeof router_1.ActivatedRoute !== "undefined" && router_1.ActivatedRoute) === "function" && _b || Object, typeof (_c = typeof category_service_1.CategoryService !== "undefined" && category_service_1.CategoryService) === "function" && _c || Object, typeof (_d = typeof ngx_cookie_1.CookieService !== "undefined" && ngx_cookie_1.CookieService) === "function" && _d || Object, typeof (_e = typeof comman_service_1.CommanService !== "undefined" && comman_service_1.CommanService) === "function" && _e || Object, typeof (_f = typeof core_1.ChangeDetectorRef !== "undefined" && core_1.ChangeDetectorRef) === "function" && _f || Object])
], AddUpdateCategoryComponent);
exports.AddUpdateCategoryComponent = AddUpdateCategoryComponent;
var _a, _b, _c, _d, _e, _f;
//# sourceMappingURL=/var/www/node_projects/angular2/efarm_admin/src/addupdate-category.component.js.map
...
var ListCategoryComponent = (function () {
    function ListCategoryComponent(_router, _categoryService, _cookieService, _flashMessagesService, _commanService) {
        this._router = _router;
    ...
    ListCategoryComponent.prototype.toInt = function (num) {
        return +num;
    };
    ListCategoryComponent.prototype.view = function (ID) {
        var route = '/category/list/' + ID;
        this._router.navigate([route]);
    };
    ListCategoryComponent.prototype.edit = function (ID) {
        var route = '/category/edit/' + ID;
        this._router.navigate([route]);
    };
    ...
    // } 
    /*Get all Users */
    ListCategoryComponent.prototype.getCategory = function () {
        var _this = this;
        this._categoryService.getAllCategory(this.rowsOnPage, this.activePage, this.sortTrem, this.searchTerm).subscribe(function (res) {
            _this.isLoading = false;
            _this.isPageLoading = false;
            if (res.success) {
                _this.data = res.data.category;
    ...
    ListCategoryComponent.prototype.onPageChange = function (event) {
        this.isLoading = true;
        this.rowsOnPage = event.rowsOnPage;
        this.activePage = event.activePage;
        this.getCategory();
    };
    ListCategoryComponent.prototype.onRowsChange = function (event) {
        this.isLoading = true;
        this.rowsOnPage = this.itemsOnPage;
        this.activePage = 1;
        this.getCategory();
    };
    ListCategoryComponent.prototype.onSortOrder = function (event) {
        this.sortTrem = this.sortBy + ' ' + this.sortOrder;
        this.isLoading = true;
        this.getCategory();
    };
    ListCategoryComponent.prototype.search = function (event, element) {
        if (element === void 0) { element = 'category'; }
        if (element == 'category') {
    ...
    ListCategoryComponent.prototype.showAlert = function () {
        var alertMessage = this._cookieService.get('categoryAlert');
        if (alertMessage) {
...
var ViewCategoryComponent = (function () {
    function ViewCategoryComponent(_router, _activatedRouter, _categoryService, _cookieService, _commanService) {
        var _this = this;
        this._router = _router;
        ...
        if (this.ID) {
            this._categoryService.get(this.ID).subscribe(function (res) {
                _this.isLoading = false;
                if (res.success) {
                    _this.category = res.data;
                }
    ...
    ViewCategoryComponent.prototype.edit = function (ID) {
        var route = '/category/edit/' + ID;
        this._router.navigate([route]);
    };
...
ViewCategoryComponent = __decorate([
    core_1.Component({
        template: __webpack_require__(1476),
...
exports.ViewCategoryComponent = ViewCategoryComponent;
var _a, _b, _c, _d, _e;
//# sourceMappingURL=/var/www/node_projects/angular2/efarm_admin/src/view-category.component.js.map
...
var routes = [
    {
        ...
        children: [
            {
                path: '',
                component: list_category_component_1.ListCategoryComponent,
                data: {
                    title: 'List'
                }
            },
            ...
            {
                path: 'add',
                component: addupdate_category_component_1.AddUpdateCategoryComponent,
                data: {
                    title: 'Add Category'
                }
            },
            {
                path: 'list/:id',
                component: view_category_component_1.ViewCategoryComponent,
                data: {
                    title: 'View'
                }
            },
...
//# sourceMappingURL=/var/www/node_projects/angular2/efarm_admin/src/category-routing.module.js.map
...
module.exports = "<div class=\"category-wrapper\">\r\n    <!-- loading section -->\r\n    <div class=\"aligncenter_loader\" *ngIf=\"isLoading\">\r\n        <div class=\"is-loading\"><i class=\"page-loader\"></i></div>\r\n    </div>\r\n    <!-- section ends  -->\r\n    <div class=\"card\" *ngIf=\"!isLoading\">\r\n        <div class=\"card-header\">\r\n            <div class=\"row\">\r\n                <div class=\"col-sm-3 col-12\">\r\n                    <strong>View Category</strong>\r\n                </div>\r\n                <div class=\"col-sm-9 col-12 text-right linehght\">\r\n                    <button type=\"button\" class=\"btn btn-secondary\" [routerLink]=\"['/category/list']\">Back</button>\r\n                    <button type=\"button\" class=\"btn btn-success pull-right\" (click)=\"edit(category.id)\">Edit</button>\r\n                    &nbsp;\r\n                </div>\r\n            </div>\r\n        </div>\r\n        <div class=\"card-block viewmode\">\r\n            <div class=\"row\">\r\n                <div class=\"col-sm-6\">\r\n                    <div class=\"form-group\">\r\n                        <label for=\"nf-name\">Name</label>\r\n                        <p>{{category.name}}</p>\r\n                    </div>\r\n                </div>\r\n                 <div class=\"col-sm-6\">\r\n                    <div class=\"form-group\">\r\n                        <label for=\"nf-name\">Type</label>\r\n                        <p>{{category.type}}</p>\r\n                    </div>\r\n                </div>\r\n              \r\n            </div>\r\n            <div class=\"row\">\r\n                <div class=\"col-sm-6\">\r\n                    <div class=\"form-group\">\r\n                        <label for=\"nf-name\">Variety</label>\r\n                        <div class=\"block\">\r\n                        <div class=\"chip\" *ngFor=\"let rcd of category.variety; let i=index\"  >\r\n                                <div class=\"chip\">{{rcd}}</div>\r\n                    </div>\r\n                    </div>\r\n                </div>\r\n                 \r\n            </div>\r\n           \r\n            \r\n        </div>\r\n    </div>\r\n    <!-- .card -->\r\n</div>\r\n<!-- .category-wrapper -->\r\n"
