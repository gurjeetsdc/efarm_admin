...
var input_service_1 = __webpack_require__(1419);
var shared_module_1 = __webpack_require__(1406);
var list_input_component_1 = __webpack_require__(1438);
var addupdate_input_component_1 = __webpack_require__(1437);
var view_input_component_1 = __webpack_require__(1439);
var inputs_routing_module_1 = __webpack_require__(1462);
...
var promptInputCategory_component_1 = __webpack_require__(1449);
var promptInputManufacturer_component_1 = __webpack_require__(1450);
...
InputsModule = __decorate([
    core_1.NgModule({
        imports: [
            inputs_routing_module_1.InputsRoutingModule,
        ...
        declarations: [
            ...
            addupdate_input_component_1.AddUpdateInputComponent,
            view_input_component_1.ViewInputComponent,
            promptInputCategory_component_1.PromptInputCategoryComponent,
            promptInputManufacturer_component_1.PromptInputManufacturerComponent
        ],
...
//# sourceMappingURL=/home/manpreets/Documents/office/efarm/efarm_admin/src/inputs.module.js.map
...
var InputService = (function () {
    function InputService(_http, _commanService) {
        this._http = _http;
        this._commanService = _commanService;
        this._host = tsConstants.HOST;
        this._accessToken = '';
    ...
    /*Use to fetch all Inputs*/
    InputService.prototype.getAllInputs = function (rowsOnPage, activePage, sortTrem, search) {
        if (search === void 0) { search = ''; }
        var headers = new http_1.Headers();
        this._accessToken = this._commanService.getAccessToken();
        var url = this._host + '/inputs?count=' + rowsOnPage + '&page=' + activePage + '&sortBy=' + sortTrem + '&search=' + search;
        ;
        headers.append('Authorization', this._accessToken);
        return this._http.get(url, { headers: headers }).map(function (res) { return res.json(); });
    };
    /*Use to add new Input*/
    InputService.prototype.add = function (input) {
        var headers = new http_1.Headers();
        this._accessToken = this._commanService.getAccessToken();
        headers.append('Authorization', this._accessToken);
        return this._http.post(this._host + '/inputs', input, { headers: headers }).map(function (res) { return res.json(); });
    };
    /*Use to get input with input id*/
    InputService.prototype.get = function (inputID) {
        var headers = new http_1.Headers();
        this._accessToken = this._commanService.getAccessToken();
        headers.append('Authorization', this._accessToken);
        return this._http.get(this._host + '/inputs/' + inputID, { headers: headers }).map(function (res) { return res.json(); });
    };
    /*Use to update input*/
    InputService.prototype.update = function (input) {
        var headers = new http_1.Headers();
        this._accessToken = this._commanService.getAccessToken();
        headers.append('Authorization', this._accessToken);
        return this._http.put(this._host + '/inputs/' + input.id, input, { headers: headers }).map(function (res) { return res.json(); });
    };
    /*Use to Delete input with input id */
    InputService.prototype.delete = function (inputId) {
        var headers = new http_1.Headers();
        this._accessToken = this._commanService.getAccessToken();
        headers.append('Authorization', this._accessToken);
        return this._http.delete(this._host + '/inputs/' + inputId, { headers: headers }).map(function (res) { return res.json(); });
    };
    /*Use to fetch all Users*/
    InputService.prototype.getAllUsers = function () {
        var headers = new http_1.Headers();
        this._accessToken = this._commanService.getAccessToken();
        headers.append('Authorization', this._accessToken);
    ...
    InputService.prototype.getAllManufactures = function () {
        var headers = new http_1.Headers();
        this._accessToken = this._commanService.getAccessToken();
        headers.append('Authorization', this._accessToken);
    ...
    InputService.prototype.getAllCategories = function () {
        var headers = new http_1.Headers();
        this._accessToken = this._commanService.getAccessToken();
        headers.append('Authorization', this._accessToken);
        return this._http.get(this._host + '/category?type=inputs&sort=name', { headers: headers }).map(function (res) { return res.json(); });
    };
    /*Use to fetch all States*/
    InputService.prototype.getStates = function () {
        var headers = new http_1.Headers();
        this._accessToken = this._commanService.getAccessToken();
        headers.append('Authorization', this._accessToken);
...
var promptInputManufacturer_component_1 = __webpack_require__(1450);
var ng2_bootstrap_modal_1 = __webpack_require__(712);
var AddUpdateInputComponent = (function () {
    function AddUpdateInputComponent(_router, dialogService, _activateRouter, _inputService, _cookieService, _commanService, changeDetectorRef) {
        var _this = this;
        this._router = _router;
        ...
        this._inputService.getAllUsers().subscribe(function (res) {
            if (res.success) {
                _this.sellers = res.data.users;
            }
        }, function (err) { });
        /*Use to get all input Manufactures*/
        this._inputService.getAllManufactures().subscribe(function (res) {
            _this.manufacturers = res.data;
        }, function (err) { });
        /*Use to get all input categories*/
        this._inputService.getAllCategories().subscribe(function (res) {
            _this.categories = res.data;
            if (_this.inputID)
                _this.setVarieties();
        }, function (err) { });
        /*Use to get all states*/
        this._inputService.getStates().subscribe(function (res) {
            _this.states = res.data;
            if (_this.inputID)
                _this.setDistrict();
        }, function (err) { });
        if (this.inputID) {
            this._inputService.get(this.inputID).subscribe(function (res) {
                _this.isPageLoading = false;
                if (res.success) {
                    _this.input = res.data;
                    if (res.data.manufacturer && res.data.manufacturer.id)
                        _this.input.manufacturerID = res.data.manufacturer.id;
                    if (res.data.user && res.data.user.id)
                        _this.input.sellerID = res.data.user.id;
                    if (res.data.category && res.data.category.id)
                        _this.input.categoryID = res.data.category.id;
                }
                else {
    ...
    AddUpdateInputComponent.prototype.showCategoryPrompt = function () {
        var _this = this;
        this.dialogService.addDialog(promptInputCategory_component_1.PromptInputCategoryComponent, {
            title: 'Add Category',
            type: 'inputs',
    ...
    AddUpdateInputComponent.prototype.setCategoryInSelectBox = function (response) {
        this.input.categoryID = response.id;
        this.setVarieties();
    };
    // Show add PromptInputManufacturerComponent Prompt
    AddUpdateInputComponent.prototype.showPrompt = function () {
        var _this = this;
        this.dialogService.addDialog(promptInputManufacturer_component_1.PromptInputManufacturerComponent, {
    ...
    AddUpdateInputComponent.prototype.setInputManufacturer = function (argu) {
        this.input.manufacturerID = argu.id;
    };
    /*If inputID exist then will update existing input otherwise will add new input*/
    AddUpdateInputComponent.prototype.save = function () {
        var _this = this;
        this.isLoading = true;
        if (this.inputID) {
            this.input["manufacturer"] = this.input["manufacturerID"];
            this.input["category"] = this.input["categoryID"];
            if (this.input["sellerID"])
                this.input["user"] = this.input["sellerID"];
            this._inputService.update(this.input).subscribe(function (res) {
                _this.response = res;
                _this.isLoading = false;
                _this._cookieService.put('inputAlert', 'Updated successfully.');
                _this._router.navigate(['/inputs/list']);
            }, function (err) {
                _this.isLoading = false;
            });
        }
            ...
            if (this.input["sellerID"])
                this.input["user"] = this.input["sellerID"];
            this._inputService.add(this.input).subscribe(function (res) {
                _this.response = res;
                _this.isLoading = false;
                _this._cookieService.put('inputAlert', 'Added successfully.');
                _this._router.navigate(['/inputs/list']);
            }, function (err) {
                _this.isLoading = false;
            });
    ...
    AddUpdateInputComponent.prototype.setVarieties = function () {
        var _this = this;
        /* reset values. */
        this.varieties = null;
        if (!this.inputID) {
        ...
        /* Initialize category. */
        var categoryID = this.input.categoryID;
        if (categoryID) {
            this.categories.filter(function (obj) { return obj.id == categoryID; }).map(function (obj) { return _this.varieties = obj.variety; });
        }
        this.changeDetectorRef.detectChanges();
    };
    /*Use to set district based on state name*/
    AddUpdateInputComponent.prototype.setDistrict = function () {
        var _this = this;
        /* reset values. */
        this.districts = null;
        if (!this.inputID) {
        ...
        /* Initialize category. */
        var stateName = this.input.state;
        if (stateName) {
            this.states.filter(function (obj) { return obj.stateName == stateName; }).map(function (obj) { return _this.districts = obj.districts; });
        }
        this.changeDetectorRef.detectChanges();
    };
    return AddUpdateInputComponent;
}());
AddUpdateInputComponent = __decorate([
    core_1.Component({
        template: __webpack_require__(1490)
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof router_1.Router !== "undefined" && router_1.Router) === "function" && _a || Object, typeof (_b = typeof ng2_bootstrap_modal_1.DialogService !== "undefined" && ng2_bootstrap_modal_1.DialogService) === "function" && _b || Object, typeof (_c = typeof router_1.ActivatedRoute !== "undefined" && router_1.ActivatedRoute) === "function" && _c || Object, typeof (_d = typeof input_service_1.InputService !== "undefined" && input_service_1.InputService) === "function" && _d || Object, typeof (_e = typeof ngx_cookie_1.CookieService !== "undefined" && ngx_cookie_1.CookieService) === "function" && _e || Object, typeof (_f = typeof comman_service_1.CommanService !== "undefined" && comman_service_1.CommanService) === "function" && _f || Object, typeof (_g = typeof core_1.ChangeDetectorRef !== "undefined" && core_1.ChangeDetectorRef) === "function" && _g || Object])
], AddUpdateInputComponent);
exports.AddUpdateInputComponent = AddUpdateInputComponent;
var _a, _b, _c, _d, _e, _f, _g;
//# sourceMappingURL=/home/manpreets/Documents/office/efarm/efarm_admin/src/addupdate-input.component.js.map
...
var ListInputComponent = (function () {
    function ListInputComponent(_router, _inputService, _cookieService, _flashMessagesService, _commanService) {
        this._router = _router;
        this._inputService = _inputService;
        this._cookieService = _cookieService;
    ...
    ListInputComponent.prototype.viewInput = function (inputID) {
        var route = '/inputs/list/' + inputID;
        this._router.navigate([route]);
    };
    ListInputComponent.prototype.editInput = function (inputID) {
        var route = '/inputs/edit/' + inputID;
        this._router.navigate([route]);
    };
    ...
    ListInputComponent.prototype.removeInput = function (inputID) {
        ...
        if (confirm("Do you want to delete?")) {
            this.isLoading = true;
            this._inputService.delete(inputID).subscribe(function (res) {
                _this.response = res;
                _this.isLoading = false;
                ...
                _this._cookieService.put('inputAlert', 'Deleted successfully.');
                /* reload page. */
                _this.getInputs();
            }, function (err) {
                _this.isLoading = false;
    ...
    /*Get all Users */
    ListInputComponent.prototype.getInputs = function () {
        var _this = this;
        this._inputService.getAllInputs(this.rowsOnPage, this.activePage, this.sortTrem, this.searchTerm).subscribe(function (res) {
            _this.isLoading = false;
            _this.isPageLoading = false;
            if (res.success) {
                _this.data = res.data.inputs;
    ...
    ListInputComponent.prototype.onPageChange = function (event) {
        this.isLoading = true;
        this.rowsOnPage = event.rowsOnPage;
        this.activePage = event.activePage;
        this.getInputs();
    };
    ListInputComponent.prototype.onRowsChange = function (event) {
        this.isLoading = true;
        this.rowsOnPage = this.itemsOnPage;
        this.activePage = 1;
        this.getInputs();
    };
    ListInputComponent.prototype.onSortOrder = function (event) {
        this.sortTrem = this.sortBy + ' ' + this.sortOrder;
        this.isLoading = true;
        this.getInputs();
    };
    ListInputComponent.prototype.search = function (event, element) {
    ...
    ListInputComponent.prototype.downloadCSV = function () {
        var i;
        var filteredData = [];
        var header = {
            name: "Name",
        ...
        for (i = 0; i < this.data.length; i++) {
            var seller = this.data[i].user ? this.data[i].user.email : '-';
            var temp = {
        ...
        var fileName = "InputsReport-" + Math.floor(Date.now() / 1000);
        new Angular2_csv_1.Angular2Csv(filteredData, fileName);
    };
    ListInputComponent.prototype.downloadPDF = function () {
        var i;
        var filteredData = [];
        var header = [
            "Name",
    ...
    ListInputComponent.prototype.showAlert = function () {
        var alertMessage = this._cookieService.get('inputAlert');
        if (alertMessage) {
...
ListInputComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof router_1.Router !== "undefined" && router_1.Router) === "function" && _a || Object, typeof (_b = typeof input_service_1.InputService !== "undefined" && input_service_1.InputService) === "function" && _b || Object, typeof (_c = typeof ngx_cookie_1.CookieService !== "undefined" && ngx_cookie_1.CookieService) === "function" && _c || Object, typeof (_d = typeof ngx_flash_messages_1.FlashMessagesService !== "undefined" && ngx_flash_messages_1.FlashMessagesService) === "function" && _d || Object, typeof (_e = typeof comman_service_1.CommanService !== "undefined" && comman_service_1.CommanService) === "function" && _e || Object])
], ListInputComponent);
...
var ViewInputComponent = (function () {
    function ViewInputComponent(_router, _activatedRouter, _inputService, _cookieService, _commanService) {
        var _this = this;
        this._router = _router;
    ...
    ViewInputComponent.prototype.editInput = function (ID) {
        var route = '/inputs/edit/' + ID;
        this._router.navigate([route]);
    };
...
var PromptInputCategoryComponent = (function (_super) {
    __extends(PromptInputCategoryComponent, _super);
    function PromptInputCategoryComponent(dialogService, _catgService) {
    ...
    PromptInputCategoryComponent.prototype.apply = function () {
        var _this = this;
        if (this.catg.name == '') {
    ...
    PromptInputCategoryComponent.prototype.addEelement = function () {
        if (!this.oBj.vname) {
    ...
    PromptInputCategoryComponent.prototype.removeEelement = function (index) {
        this.catg.variety.splice(index, 1);
    };
    return PromptInputCategoryComponent;
}(ng2_bootstrap_modal_1.DialogComponent));
PromptInputCategoryComponent = __decorate([
    core_1.Component({
        selector: 'prompt',
...
exports.PromptInputCategoryComponent = PromptInputCategoryComponent;
var _a, _b;
//# sourceMappingURL=/home/manpreets/Documents/office/efarm/efarm_admin/src/promptInputCategory.component.js.map
...
var PromptInputManufacturerComponent = (function (_super) {
    __extends(PromptInputManufacturerComponent, _super);
    function PromptInputManufacturerComponent(dialogService, _manufacturerService) {
        var _this = _super.call(this, dialogService) || this;
    ...
    PromptInputManufacturerComponent.prototype.apply = function () {
        var _this = this;
    ...
    return PromptInputManufacturerComponent;
}(ng2_bootstrap_modal_1.DialogComponent));
PromptInputManufacturerComponent = __decorate([
    core_1.Component({
        selector: 'prompt',
...
exports.PromptInputManufacturerComponent = PromptInputManufacturerComponent;
var _a, _b;
//# sourceMappingURL=/home/manpreets/Documents/office/efarm/efarm_admin/src/promptInputManufacturer.component.js.map
...
var routes = [
    {
        ...
        children: [
            ...
            {
                path: 'add',
                component: addupdate_input_component_1.AddUpdateInputComponent,
                data: {
                    title: 'Add Input'
                }
            },
...
exports.InputsRoutingModule = InputsRoutingModule;
//# sourceMappingURL=/home/manpreets/Documents/office/efarm/efarm_admin/src/inputs-routing.module.js.map
...
module.exports = "<div class=\"input-wrapper\">\r\n    <!-- loading section -->\r\n    <div class=\"aligncenter_loader\" *ngIf=\"isLoading\">\r\n        <div class=\"is-loading\"><i class=\"page-loader\"></i></div>\r\n    </div>\r\n    <!-- section ends  -->\r\n    <div class=\"card\" *ngIf=\"!isLoading\">\r\n        <div class=\"card-header\">\r\n            <div class=\"row\">\r\n                <div class=\"col-sm-3 col-12\">\r\n                    <strong>View Input</strong>\r\n                </div>\r\n                <div class=\"col-sm-9 col-12 text-right linehght\">\r\n                    <button type=\"button\" class=\"btn btn-secondary\" [routerLink]=\"['/inputs/list']\">Back</button>\r\n                    <button type=\"button\" class=\"btn btn-success pull-right\" (click)=\"editInput(input.id)\">Edit Input</button>\r\n                    &nbsp;\r\n                </div>\r\n            </div>\r\n        </div>\r\n        <div class=\"card-block viewmode\">\r\n            <div class=\"row\">\r\n                <div class=\"col-sm-6\">\r\n                    <div class=\"form-group\">\r\n                        <label for=\"nf-name\">Name</label>\r\n                        <p>{{input.name}}</p>\r\n                    </div>\r\n                </div>\r\n                <div class=\"col-sm-6\">\r\n                    <div class=\"form-group\">\r\n                        <label>Channel Partner</label>\r\n                        <p>{{input.user?.email ? input.user?.email : '-'}}</p>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n            <div class=\"row\">\r\n                <div class=\"col-sm-6\">\r\n                    <div class=\"form-group\">\r\n                        <label>Category</label>\r\n                        <p>{{input.category?.name}}</p>\r\n                    </div>\r\n                </div>\r\n                <div class=\"col-sm-6\">\r\n                    <div class=\"form-group\">\r\n                        <label for=\"nf-variety\">Variety</label>\r\n                        <p>{{input.variety ? input.variety : '-'}}</p>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n            <div class=\"row\">\r\n                <div class=\"col-sm-6\">\r\n                    <div class=\"form-group\">\r\n                        <label>Company/Manufacturer</label>\r\n                        <p>{{input.manufacturer?.name ? input.manufacturer?.name : '-'}}</p>\r\n                    </div>\r\n                </div>\r\n                <div class=\"col-sm-6\">\r\n                    <div class=\"form-group\">\r\n                        <label for=\"nf-price\">Price</label>\r\n                        <p><i class=\"fa fa-rupee\"></i> {{input.price}}/{{input.priceUnit}}</p>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n            <div class=\"row\">\r\n                <div class=\"col-sm-6\">\r\n                    <div class=\"form-group\">\r\n                        <label for=\"nf-grade\">Quantity</label>\r\n                        <p>{{input.quantity ? input.quantity : '-'}}</p>\r\n                    </div>\r\n                </div>\r\n                <div class=\"col-sm-6\">\r\n                    <div class=\"form-group\">\r\n                        <label for=\"nf-variety\">Address</label>\r\n                        <p>{{input.address}}</p>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n            <div class=\"row\">\r\n                <div class=\"col-sm-6\">\r\n                    <div class=\"form-group\">\r\n                        <label for=\"nf-variety\">City</label>\r\n                        <p>{{input.city}}</p>\r\n                    </div>\r\n                </div>\r\n                <div class=\"col-sm-6\">\r\n                    <div class=\"form-group\">\r\n                        <label for=\"nf-variety\">State</label>\r\n                        <p>{{input.state}}</p>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n            <div class=\"row\">\r\n                <div class=\"col-sm-6\">\r\n                    <div class=\"form-group\">\r\n                        <label for=\"nf-variety\">District</label>\r\n                        <p>{{input.district}}</p>\r\n                    </div>\r\n                </div>\r\n                <div class=\"col-sm-6\">\r\n                    <div class=\"form-group\">\r\n                        <label for=\"nf-variety\">Pin Code</label>\r\n                        <p>{{input.pincode}}</p>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n            <div class=\"row\">\r\n                <div class=\"col-sm-6\">\r\n                    <div class=\"form-group\">\r\n                        <label for=\"nf-termsConditions\">Additional information</label>\r\n                        <p>{{input.additionalInformation ? input.additionalInformation : '-'}}</p>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n    <!-- .card -->\r\n</div>\r\n<!-- .input-wrapper -->\r\n"
