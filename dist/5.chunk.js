...
var list_user_component_1 = __webpack_require__(1449);
var addupdate_user_component_1 = __webpack_require__(1448);
var view_user_component_1 = __webpack_require__(1450);
var users_routing_module_1 = __webpack_require__(1461);
...
UsersModule = __decorate([
    core_1.NgModule({
        ...
        declarations: [
            ...
            addupdate_user_component_1.AddUpdateUserComponent,
            view_user_component_1.ViewUserComponent
        ]
    })
], UsersModule);
exports.UsersModule = UsersModule;
//# sourceMappingURL=/var/www/node_projects/angular2/efarm_admin/src/users.module.js.map
...
var UserService = (function () {
    function UserService(_http, _commanService) {
        this._http = _http;
    ...
    UserService.prototype.getAllUsers = function (rowsOnPage, activePage, sortTrem, search, roles) {
        if (search === void 0) { search = ''; }
        if (roles === void 0) { roles = 'U'; }
...
var _a, _b;
//# sourceMappingURL=/var/www/node_projects/angular2/efarm_admin/src/user.service.js.map
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(0);
var user_service_1 = __webpack_require__(1421);
var router_1 = __webpack_require__(75);
var ngx_cookie_1 = __webpack_require__(90);
var ngx_flash_messages_1 = __webpack_require__(711);
var AddUpdateUserComponent = (function () {
    function AddUpdateUserComponent(_router, _activateRouter, _userService, _cookieService, changeDetectorRef, _flashMessagesService) {
        var _this = this;
        this._router = _router;
        ...
        if (this.userID) {
            this._userService.get(this.userID).subscribe(function (res) {
                if (res.success) {
                    _this.user = res.data;
        ...
        this._userService.getStates().subscribe(function (res) {
    ...
    AddUpdateUserComponent.prototype.save = function () {
        ...
        if (this.userID) {
            ...
            this._userService.update(this.user).subscribe(function (res) {
                if (res.success) {
            ...
            this.user["username"] = this.user["email"];
            this._userService.add(this.user).subscribe(function (res) {
                _this.isLoading = false;
                if (res.success) {
    ...
    AddUpdateUserComponent.prototype.setDistrict = function () {
        var _this = this;
        /* reset values. */
        this.districts = null;
        if (!this.userID) {
    ...
    /*This function is use to remove user session if Access token expired. */
    AddUpdateUserComponent.prototype.checkAccessToken = function (err) {
        var code = err.code;
        var message = err.message;
        if ((code == 401 && message == "authorization")) {
            this._cookieService.removeAll();
    ...
    AddUpdateUserComponent.prototype.showAlert = function () {
        this._flashMessagesService.show(this.errMessage, {
            classes: ['alert', 'alert-danger'],
            timeout: 3000,
        });
    };
    return AddUpdateUserComponent;
}());
AddUpdateUserComponent = __decorate([
    core_1.Component({
        template: __webpack_require__(1497)
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof router_1.Router !== "undefined" && router_1.Router) === "function" && _a || Object, typeof (_b = typeof router_1.ActivatedRoute !== "undefined" && router_1.ActivatedRoute) === "function" && _b || Object, typeof (_c = typeof user_service_1.UserService !== "undefined" && user_service_1.UserService) === "function" && _c || Object, typeof (_d = typeof ngx_cookie_1.CookieService !== "undefined" && ngx_cookie_1.CookieService) === "function" && _d || Object, typeof (_e = typeof core_1.ChangeDetectorRef !== "undefined" && core_1.ChangeDetectorRef) === "function" && _e || Object, typeof (_f = typeof ngx_flash_messages_1.FlashMessagesService !== "undefined" && ngx_flash_messages_1.FlashMessagesService) === "function" && _f || Object])
], AddUpdateUserComponent);
exports.AddUpdateUserComponent = AddUpdateUserComponent;
var _a, _b, _c, _d, _e, _f;
//# sourceMappingURL=/var/www/node_projects/angular2/efarm_admin/src/addupdate-user.component.js.map
...
var ListUserComponent = (function () {
    ...
    ListUserComponent.prototype.toInt = function (num) {
        return +num;
    };
    ListUserComponent.prototype.viewUser = function (userID) {
        var route = '/users/list/' + userID;
        this._router.navigate([route]);
    };
    ListUserComponent.prototype.editUser = function (userID) {
        var route = '/users/edit/' + userID;
        this._router.navigate([route]);
    };
    ListUserComponent.prototype.removeUser = function (userID) {
        var _this = this;
        if (confirm("Do you want to delete?")) {
            this.isLoading = true;
            this._userService.delete(userID).subscribe(function (res) {
                _this.response = res;
                _this.isLoading = false;
    ...
    ListUserComponent.prototype.removeByAttr = function (arr, attr, value) {
        var i = arr.length;
        while (i--) {
            if (arr[i]
    ...
    /*This function is use to remove user session if Access token expired. */
    ListUserComponent.prototype.checkAccessToken = function (err) {
        var code = err.code;
        var message = err.message;
        if ((code == 401 && message == "authorization")) {
            this._cookieService.removeAll();
    ...
    ListUserComponent.prototype.getUsers = function () {
        var _this = this;
        this._userService.getAllUsers(this.rowsOnPage, this.activePage, this.sortTrem, this.searchTerm, this.roles).subscribe(function (res) {
            _this.isLoading = false;
            _this.isPageLoading = false;
            if (res.success) {
    ...
    ListUserComponent.prototype.onPageChange = function (event) {
        this.isLoading = true;
        this.rowsOnPage = event.rowsOnPage;
        this.activePage = event.activePage;
        this.getUsers();
    };
    ListUserComponent.prototype.onRowsChange = function (event) {
        this.isLoading = true;
        this.rowsOnPage = this.itemsOnPage;
        this.activePage = 1;
        this.getUsers();
    };
    ListUserComponent.prototype.onSortOrder = function (event) {
        this.sortTrem = this.sortBy + ' ' + this.sortOrder;
        this.isLoading = true;
        this.getUsers();
    };
    ListUserComponent.prototype.search = function (event, element) {
    ...
    ListUserComponent.prototype.downloadCSV = function () {
        var i;
        var filteredData = [];
        var header = {
            name: "Name",
        ...
        var fileName = "UsersReport-" + Math.floor(Date.now() / 1000);
        new Angular2_csv_1.Angular2Csv(filteredData, fileName);
    };
    ListUserComponent.prototype.downloadPDF = function () {
        var i;
        var filteredData = [];
        var header = [
            "Name",
    ...
    ListUserComponent.prototype.showAlert = function () {
...
var _a, _b, _c, _d;
//# sourceMappingURL=/var/www/node_projects/angular2/efarm_admin/src/list-user.component.js.map
...
var ViewUserComponent = (function () {
    ...
    ViewUserComponent.prototype.removeUser = function (userid) {
        var _this = this;
        if (confirm("Do you want to delete?")) {
            this.isLoading = true;
            this._userService.delete(userid).subscribe(function (res) {
    ...
    /*This function is use to remove user session if Access token expired. */
    ViewUserComponent.prototype.checkAccessToken = function (err) {
        var code = err.code;
        var message = err.message;
        if ((code == 401 && message == "authorization")) {
            this._cookieService.removeAll();
...
var _a, _b, _c, _d;
//# sourceMappingURL=/var/www/node_projects/angular2/efarm_admin/src/view-user.component.js.map
...
var routes = [
    {
        ...
        children: [
            ...
            {
                path: 'add',
                component: addupdate_user_component_1.AddUpdateUserComponent,
                data: {
                    title: 'Add User'
                }
            },
...
//# sourceMappingURL=/var/www/node_projects/angular2/efarm_admin/src/users-routing.module.js.map
