...
var list_admin_user_component_1 = __webpack_require__(1425);
var addupdate_admin_user_component_1 = __webpack_require__(1424);
var view_admin_user_component_1 = __webpack_require__(1426);
var admin_users_routing_module_1 = __webpack_require__(1457);
...
AdminUsersModule = __decorate([
    core_1.NgModule({
        imports: [
            admin_users_routing_module_1.AdminUsersRoutingModule,
        ...
        declarations: [
            list_admin_user_component_1.ListAdminUserComponent,
            addupdate_admin_user_component_1.AddUpdateAdminUserComponent,
            view_admin_user_component_1.ViewAdminUserComponent
        ]
    })
], AdminUsersModule);
exports.AdminUsersModule = AdminUsersModule;
//# sourceMappingURL=/home/manpreets/Documents/office/efarm/efarm_admin/src/admin-users.module.js.map
...
var AdminUserService = (function () {
    function AdminUserService(_http, _commanService) {
        this._http = _http;
    ...
    AdminUserService.prototype.getAllAdminUsers = function (rowsOnPage, activePage, sortTrem, search, roles) {
        if (search === void 0) { search = ''; }
        if (roles === void 0) { roles = 'A'; }
        var headers = new http_1.Headers();
        this._accessToken = this._commanService.getAccessToken();
        var url = this._host + '/user?count=' + rowsOnPage + '&page=' + activePage + '&sortBy=' + sortTrem + '&roles=' + roles + '&search=' + search;
        headers.append('Authorization', this._accessToken);
        return this._http.get(url, { headers: headers }).map(function (res) { return res.json(); });
    };
    /*Use to add new user*/
    AdminUserService.prototype.add = function (user) {
        var headers = new http_1.Headers();
        this._accessToken = this._commanService.getAccessToken();
        headers.append('Authorization', this._accessToken);
        return this._http.post(this._host + '/user', user, { headers: headers }).map(function (res) { return res.json(); });
    };
    /*User to get user detail with ID*/
    AdminUserService.prototype.get = function (userid) {
        var headers = new http_1.Headers();
        this._accessToken = this._commanService.getAccessToken();
        headers.append('Authorization', this._accessToken);
        return this._http.get(this._host + '/user/' + userid, { headers: headers }).map(function (res) { return res.json(); });
    };
    /*Use to update user detail with there ID*/
    AdminUserService.prototype.update = function (user) {
        var headers = new http_1.Headers();
        this._accessToken = this._commanService.getAccessToken();
        headers.append('Authorization', this._accessToken);
        return this._http.put(this._host + '/user/' + user.id, user, { headers: headers }).map(function (res) { return res.json(); });
    };
    /** Delete user by ID **/
    AdminUserService.prototype.delete = function (userID) {
        var headers = new http_1.Headers();
        this._accessToken = this._commanService.getAccessToken();
        headers.append('Authorization', this._accessToken);
        return this._http.delete(this._host + '/user/' + userID, { headers: headers }).map(function (res) { return res.json(); });
    };
    /*Use to fetch all States*/
    AdminUserService.prototype.getStates = function () {
        var headers = new http_1.Headers();
        this._accessToken = this._commanService.getAccessToken();
        headers.append('Authorization', this._accessToken);
    ...
    /*Use to fetch all States*/
    AdminUserService.prototype.getRoles = function () {
        var headers = new http_1.Headers();
        this._accessToken = this._commanService.getAccessToken();
        headers.append('Authorization', this._accessToken);
        return this._http.get(this._host + '/roles?sort=name', { headers: headers }).map(function (res) { return res.json(); });
    };
...
var _a, _b;
//# sourceMappingURL=/home/manpreets/Documents/office/efarm/efarm_admin/src/admin-user.service.js.map
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(0);
var admin_user_service_1 = __webpack_require__(1416);
var comman_service_1 = __webpack_require__(1392);
var router_1 = __webpack_require__(75);
var ngx_cookie_1 = __webpack_require__(90);
var ngx_flash_messages_1 = __webpack_require__(711);
var AddUpdateAdminUserComponent = (function () {
    function AddUpdateAdminUserComponent(_router, _activateRouter, _adminUserService, _cookieService, _commanService, _changeDetectorRef, _flashMessagesService) {
        var _this = this;
        this._router = _router;
        ...
        if (this.userID) {
            this._adminUserService.get(this.userID).subscribe(function (res) {
        ...
        this._adminUserService.getStates().subscribe(function (res) {
            _this.states = res.data;
            // if( this.userID ) this.setDistrict();
        }, function (err) { });
        /*Use to get all roles*/
        this._adminUserService.getRoles().subscribe(function (res) {
            console.log("all roles", res);
            _this.roles = res.data;
        }, function (err) { });
    }
    /*If useID exist then will update existing user otherwise will add new user*/
    AddUpdateAdminUserComponent.prototype.save = function () {
        var _this = this;
        this.isLoading = true;
        if (this.userID) {
            this.user["username"] = this.user["email"];
            this.user["roleId"] = this.user["roleID"];
            this._adminUserService.update(this.user).subscribe(function (res) {
                _this.isLoading = false;
                if (res.success) {
                    _this._cookieService.put('userAlert', 'Updated successfully.');
                    _this._router.navigate(['/admin-users/list']);
                }
                else {
                    _this._commanService.checkAccessToken(res.error);
                }
            ...
            this.user["username"] = this.user["email"];
            this.user["roleId"] = this.user["roleID"];
            this._adminUserService.add(this.user).subscribe(function (res) {
                _this.isLoading = false;
                if (res.success) {
                    _this._cookieService.put('userAlert', 'Added successfully.');
                    _this._router.navigate(['/admin-users/list']);
                }
                else {
                    window.scrollTo(0, 0);
    ...
    // }
    AddUpdateAdminUserComponent.prototype.showAlert = function () {
        this._flashMessagesService.show(this.errMessage, {
            classes: ['alert', 'alert-danger'],
            timeout: 3000,
        });
    };
    return AddUpdateAdminUserComponent;
}());
AddUpdateAdminUserComponent = __decorate([
    core_1.Component({
        template: __webpack_require__(1477)
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof router_1.Router !== "undefined" && router_1.Router) === "function" && _a || Object, typeof (_b = typeof router_1.ActivatedRoute !== "undefined" && router_1.ActivatedRoute) === "function" && _b || Object, typeof (_c = typeof admin_user_service_1.AdminUserService !== "undefined" && admin_user_service_1.AdminUserService) === "function" && _c || Object, typeof (_d = typeof ngx_cookie_1.CookieService !== "undefined" && ngx_cookie_1.CookieService) === "function" && _d || Object, typeof (_e = typeof comman_service_1.CommanService !== "undefined" && comman_service_1.CommanService) === "function" && _e || Object, typeof (_f = typeof core_1.ChangeDetectorRef !== "undefined" && core_1.ChangeDetectorRef) === "function" && _f || Object, typeof (_g = typeof ngx_flash_messages_1.FlashMessagesService !== "undefined" && ngx_flash_messages_1.FlashMessagesService) === "function" && _g || Object])
], AddUpdateAdminUserComponent);
exports.AddUpdateAdminUserComponent = AddUpdateAdminUserComponent;
var _a, _b, _c, _d, _e, _f, _g;
//# sourceMappingURL=/home/manpreets/Documents/office/efarm/efarm_admin/src/addupdate-admin-user.component.js.map
...
var ngx_flash_messages_1 = __webpack_require__(711);
var ListAdminUserComponent = (function () {
    function ListAdminUserComponent(_router, _adminUserService, _cookieService, _commanService, _flashMessagesService) {
        this._router = _router;
        this._adminUserService = _adminUserService;
        this._cookieService = _cookieService;
        this._commanService = _commanService;
    ...
    ListAdminUserComponent.prototype.ngOnInit = function () {
    ...
    ListAdminUserComponent.prototype.toInt = function (num) {
        return +num;
    };
    ListAdminUserComponent.prototype.viewUser = function (userID) {
        var route = '/admin-users/list/' + userID;
        this._router.navigate([route]);
    };
    ListAdminUserComponent.prototype.editUser = function (userID) {
        var route = '/admin-users/edit/' + userID;
        this._router.navigate([route]);
    };
    ListAdminUserComponent.prototype.removeUser = function (userID) {
        var _this = this;
        if (confirm("Do you want to delete?")) {
            this.isLoading = true;
            this._adminUserService.delete(userID).subscribe(function (res) {
                _this.response = res;
                _this.isLoading = false;
    ...
    /*Get all Users */
    ListAdminUserComponent.prototype.getUsers = function () {
        var _this = this;
        this._adminUserService.getAllAdminUsers(this.rowsOnPage, this.activePage, this.sortTrem, this.searchTerm, this.roles).subscribe(function (res) {
            _this.isLoading = false;
            _this.isPageLoading = false;
            if (res.success) {
    ...
    ListAdminUserComponent.prototype.onPageChange = function (event) {
        this.isLoading = true;
        this.rowsOnPage = event.rowsOnPage;
        this.activePage = event.activePage;
        this.getUsers();
    };
    ListAdminUserComponent.prototype.onRowsChange = function (event) {
        this.isLoading = true;
        this.rowsOnPage = this.itemsOnPage;
        this.activePage = 1;
        this.getUsers();
    };
    ListAdminUserComponent.prototype.onSortOrder = function (event) {
        this.sortTrem = this.sortBy + ' ' + this.sortOrder;
        this.isLoading = true;
        this.getUsers();
    };
    ListAdminUserComponent.prototype.search = function (event, element) {
    ...
    ListAdminUserComponent.prototype.downloadCSV = function () {
        var i;
        var filteredData = [];
        var header = {
            name: "Name",
        ...
        for (i = 0; i < this.data.length; i++) {
            var date = new Date(this.data[i].createdAt);
            var registeredOn = date.getDate() + '/' + (date.getMonth() + 1) + '/' + date.getFullYear();
            var temp = {
        ...
        var fileName = "AdminUsersReport-" + Math.floor(Date.now() / 1000);
        new Angular2_csv_1.Angular2Csv(filteredData, fileName);
    };
    ListAdminUserComponent.prototype.downloadPDF = function () {
        var i;
        var filteredData = [];
        var header = [
            "Name",
    ...
    ListAdminUserComponent.prototype.showAlert = function () {
        var alertMessage = this._cookieService.get('userAlert');
        if (alertMessage) {
    ...
    return ListAdminUserComponent;
}());
ListAdminUserComponent = __decorate([
    core_1.Component({
        selector: 'app-users',
        template: __webpack_require__(1478),
        styles: [__webpack_require__(1468)]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof router_1.Router !== "undefined" && router_1.Router) === "function" && _a || Object, typeof (_b = typeof admin_user_service_1.AdminUserService !== "undefined" && admin_user_service_1.AdminUserService) === "function" && _b || Object, typeof (_c = typeof ngx_cookie_1.CookieService !== "undefined" && ngx_cookie_1.CookieService) === "function" && _c || Object, typeof (_d = typeof comman_service_1.CommanService !== "undefined" && comman_service_1.CommanService) === "function" && _d || Object, typeof (_e = typeof ngx_flash_messages_1.FlashMessagesService !== "undefined" && ngx_flash_messages_1.FlashMessagesService) === "function" && _e || Object])
], ListAdminUserComponent);
exports.ListAdminUserComponent = ListAdminUserComponent;
var _a, _b, _c, _d, _e;
//# sourceMappingURL=/home/manpreets/Documents/office/efarm/efarm_admin/src/list-admin-user.component.js.map
...
var ngx_cookie_1 = __webpack_require__(90);
var comman_service_1 = __webpack_require__(1392);
var ViewAdminUserComponent = (function () {
    function ViewAdminUserComponent(_route, _router, _adminUserService, _cookieService, _commanService) {
        var _this = this;
        this._route = _route;
        this._router = _router;
        this._adminUserService = _adminUserService;
    ...
    ViewAdminUserComponent.prototype.editUser = function (userid) {
        var route = '/admin-users/edit/' + userid;
        this._router.navigate([route]);
    };
    ViewAdminUserComponent.prototype.removeUser = function (userid) {
        var _this = this;
        if (confirm("Do you want to delete?")) {
            this.isLoading = true;
            this._adminUserService.delete(userid).subscribe(function (res) {
...
var routes = [
    {
        ...
        children: [
            {
                path: '',
                component: list_admin_user_component_1.ListAdminUserComponent,
                data: {
                    title: 'List'
                }
            },
            ...
            {
                path: 'add',
                component: addupdate_admin_user_component_1.AddUpdateAdminUserComponent,
                data: {
            ...
            {
                path: 'list/:id',
                component: view_admin_user_component_1.ViewAdminUserComponent,
                data: {
                    title: 'View'
                }
            },
...
var AdminUsersRoutingModule = (function () {
    function AdminUsersRoutingModule() {
    }
    return AdminUsersRoutingModule;
}());
AdminUsersRoutingModule = __decorate([
    core_1.NgModule({
        imports: [
...
exports.AdminUsersRoutingModule = AdminUsersRoutingModule;
//# sourceMappingURL=/home/manpreets/Documents/office/efarm/efarm_admin/src/admin-users-routing.module.js.map
...
module.exports = "<div>\n    <!-- loading section -->\n    <div class=\"aligncenter_loader\" *ngIf=\"isLoading\">\n        <div class=\"is-loading\"><i class=\"page-loader\"></i></div>\n    </div>\n    <!-- section ends  -->\n    <div class=\"row\" *ngIf=\"!isLoading\">\n        <div class=\"col-sm-12 col-md-9 col-12\">\n            <div class=\"card\">\n                <div class=\"card-header\">\n                    <div class=\"row\">\n                        <div class=\"col-sm-6 col-12\">\n                            <strong>View Admin User</strong>\n                        </div>\n                        <div class=\"col-sm-6 col-12 text-right linehght\">\n                            <button class=\"btn btn-secondary pull-right widthset\" type=\"button\" [routerLink]=\"['/admin-users/list']\">Back</button>\n                        </div>\n                    </div>\n                </div>\n                <div class=\"card-block userdetail\">\n                    <div class=\"table-responsive\">\n                        <table class=\"table\">\n                            <tbody>\n                                <tr>\n                                    <th width=\"20%\">Name</th>\n                                    <td data-label=\"Name\">{{user.firstName}} {{user.lastName}}</td>\n                                </tr>\n                                <tr>\n                                    <th width=\"20%\">Role</th>\n                                    <td data-label=\"Role\">{{user.roleId?.name}}</td>\n                                </tr>\n                                <tr>\n                                    <th width=\"20%\">Email</th>\n                                    <td data-label=\"Email\">{{user.email}}</td>\n                                </tr>\n                                <tr>\n                                    <th width=\"20%\">Mobile</th>\n                                    <td data-label=\"Mobile\">{{user.mobile}}</td>\n                                </tr>\n                                <tr>\n                                    <th width=\"20%\">Market</th>\n                                    <td data-label=\"Market\">{{user.state}}</td>\n                                </tr>\n                                <tr>\n                                    <th width=\"20%\">Registered on</th>\n                                    <td data-label=\"Registered on\">{{user.createdAt | date:'dd/MM/yyyy'}}</td>\n                                </tr>\n                                <tr>\n                                    <th width=\"20%\">Modified on</th>\n                                    <td data-label=\"Modified on\">{{user.updatedAt | date:'dd/MM/yyyy'}}</td>\n                                </tr>\n                            </tbody>\n                        </table>\n                    </div>\n                </div>\n            </div>\n        </div>\n        <div class=\"col-sm-12 col-md-3 col-12\">\n            <div class=\"card actions\">\n                <h2>Actions</h2>\n                <ul>\n                    <li style=\"cursor:pointer;\" (click)=\"editUser(user.id)\"><span>Edit Admin User</span></li>\n                    <li style=\"cursor:pointer;\" (click)=\"removeUser(user.id)\"><span>Delete Admin User</span></li>\n                </ul>\n            </div>\n        </div>\n    </div>\n</div>\n"
