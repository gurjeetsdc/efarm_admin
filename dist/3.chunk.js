...
var list_manufacturer_component_1 = __webpack_require__(1442);
var addupdate_manufacturer_component_1 = __webpack_require__(1441);
var view_manufacturer_component_1 = __webpack_require__(1443);
var manufacturer_routing_module_1 = __webpack_require__(1458);
var manufacturer_service_1 = __webpack_require__(1419);
...
ManufacturerModule = __decorate([
    core_1.NgModule({
        imports: [
            manufacturer_routing_module_1.ManufacturerRoutingModule,
        ...
        declarations: [
            list_manufacturer_component_1.ListManufacturerComponent,
            addupdate_manufacturer_component_1.AddUpdateManufacturerComponent,
            view_manufacturer_component_1.ViewManufacturerComponent
        ]
    })
], ManufacturerModule);
exports.ManufacturerModule = ManufacturerModule;
//# sourceMappingURL=/var/www/node_projects/angular2/efarm_admin/src/manufacturer.module.js.map
...
var _a, _b;
//# sourceMappingURL=/var/www/node_projects/angular2/efarm_admin/src/manufacturer.service.js.map
...
var ngx_cookie_1 = __webpack_require__(90);
var comman_service_1 = __webpack_require__(1396);
var AddUpdateManufacturerComponent = (function () {
    function AddUpdateManufacturerComponent(_router, _activateRouter, _manufacturerService, _cookieService, _commanService, changeDetectorRef) {
        var _this = this;
        this._router = _router;
        ...
        if (this.manufacturerID) {
            this._manufacturerService.get(this.manufacturerID).subscribe(function (res) {
                _this.isPageLoading = false;
                if (res.success) {
                    _this.manufacturer = res.data;
                }
                else {
    ...
    AddUpdateManufacturerComponent.prototype.save = function () {
        var _this = this;
        this.isLoading = true;
        if (this.manufacturerID) {
            this._manufacturerService.update(this.manufacturer).subscribe(function (res) {
                _this.isLoading = false;
                _this._cookieService.put('manufacturerAlert', 'Updated successfully.');
                _this._router.navigate(['/manufacturer/list']);
            }, function (err) {
                _this.isLoading = false;
            });
        }
            ...
            this._manufacturerService.add(this.manufacturer).subscribe(function (res) {
                _this.isLoading = false;
                _this._cookieService.put('manufacturerAlert', 'Added successfully.');
                _this._router.navigate(['/manufacturer/list']);
            }, function (err) {
                _this.isLoading = false;
            });
    ...
    return AddUpdateManufacturerComponent;
}());
AddUpdateManufacturerComponent = __decorate([
    core_1.Component({
        template: __webpack_require__(1490)
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof router_1.Router !== "undefined" && router_1.Router) === "function" && _a || Object, typeof (_b = typeof router_1.ActivatedRoute !== "undefined" && router_1.ActivatedRoute) === "function" && _b || Object, typeof (_c = typeof manufacturer_service_1.ManufacturerService !== "undefined" && manufacturer_service_1.ManufacturerService) === "function" && _c || Object, typeof (_d = typeof ngx_cookie_1.CookieService !== "undefined" && ngx_cookie_1.CookieService) === "function" && _d || Object, typeof (_e = typeof comman_service_1.CommanService !== "undefined" && comman_service_1.CommanService) === "function" && _e || Object, typeof (_f = typeof core_1.ChangeDetectorRef !== "undefined" && core_1.ChangeDetectorRef) === "function" && _f || Object])
], AddUpdateManufacturerComponent);
exports.AddUpdateManufacturerComponent = AddUpdateManufacturerComponent;
var _a, _b, _c, _d, _e, _f;
//# sourceMappingURL=/var/www/node_projects/angular2/efarm_admin/src/addupdate-manufacturer.component.js.map
...
var ngx_flash_messages_1 = __webpack_require__(711);
var comman_service_1 = __webpack_require__(1396);
var ListManufacturerComponent = (function () {
    function ListManufacturerComponent(_router, _cookieService, _commanService, _manufacturerService, _flashMessagesService) {
        this._router = _router;
        this._cookieService = _cookieService;
        this._commanService = _commanService;
        this._manufacturerService = _manufacturerService;
    ...
    ListManufacturerComponent.prototype.ngOnInit = function () {
    ...
    ListManufacturerComponent.prototype.toInt = function (num) {
        return +num;
    };
    ListManufacturerComponent.prototype.viewManufacturer = function (manufacturerID) {
        var route = '/manufacturer/list/' + manufacturerID;
        this._router.navigate([route]);
    };
    ListManufacturerComponent.prototype.editManufacturer = function (manufacturerID) {
        var route = '/manufacturer/edit/' + manufacturerID;
        this._router.navigate([route]);
    };
    ...
    ListManufacturerComponent.prototype.getManufacturer = function () {
        var _this = this;
        this._manufacturerService.getAllManufacturer(this.rowsOnPage, this.activePage, this.sortTrem, this.searchTerm).subscribe(function (res) {
            _this.isLoading = false;
            _this.isPageLoading = false;
            if (res.success) {
                _this.data = res.data.manufacturers;
    ...
    ListManufacturerComponent.prototype.onPageChange = function (event) {
        this.isLoading = true;
        this.rowsOnPage = event.rowsOnPage;
        this.activePage = event.activePage;
        this.getManufacturer();
    };
    ListManufacturerComponent.prototype.onRowsChange = function (event) {
        this.isLoading = true;
        this.rowsOnPage = this.itemsOnPage;
        this.activePage = 1;
        this.getManufacturer();
    };
    ListManufacturerComponent.prototype.onSortOrder = function (event) {
        this.sortTrem = this.sortBy + ' ' + this.sortOrder;
        this.isLoading = true;
        this.getManufacturer();
    };
    ListManufacturerComponent.prototype.search = function (event, element) {
    ...
    ListManufacturerComponent.prototype.showAlert = function () {
        var alertMessage = this._cookieService.get('manufacturerAlert');
        if (alertMessage) {
    ...
    return ListManufacturerComponent;
}());
ListManufacturerComponent = __decorate([
    core_1.Component({
        selector: 'app-manufacturers',
        template: __webpack_require__(1491),
        styles: [__webpack_require__(1468)]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof router_1.Router !== "undefined" && router_1.Router) === "function" && _a || Object, typeof (_b = typeof ngx_cookie_1.CookieService !== "undefined" && ngx_cookie_1.CookieService) === "function" && _b || Object, typeof (_c = typeof comman_service_1.CommanService !== "undefined" && comman_service_1.CommanService) === "function" && _c || Object, typeof (_d = typeof manufacturer_service_1.ManufacturerService !== "undefined" && manufacturer_service_1.ManufacturerService) === "function" && _d || Object, typeof (_e = typeof ngx_flash_messages_1.FlashMessagesService !== "undefined" && ngx_flash_messages_1.FlashMessagesService) === "function" && _e || Object])
], ListManufacturerComponent);
exports.ListManufacturerComponent = ListManufacturerComponent;
var _a, _b, _c, _d, _e;
//# sourceMappingURL=/var/www/node_projects/angular2/efarm_admin/src/list-manufacturer.component.js.map
...
var ViewManufacturerComponent = (function () {
    function ViewManufacturerComponent(_router, _route, _manufacturerService, _commanService) {
        var _this = this;
        this._router = _router;
        this._route = _route;
        this._manufacturerService = _manufacturerService;
    ...
    ViewManufacturerComponent.prototype.editManufacturer = function (manufacturerid) {
        var route = '/manufacturer/edit/' + manufacturerid;
        this._router.navigate([route]);
    };
...
ViewManufacturerComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof router_1.Router !== "undefined" && router_1.Router) === "function" && _a || Object, typeof (_b = typeof router_1.ActivatedRoute !== "undefined" && router_1.ActivatedRoute) === "function" && _b || Object, typeof (_c = typeof manufacturer_service_1.ManufacturerService !== "undefined" && manufacturer_service_1.ManufacturerService) === "function" && _c || Object, typeof (_d = typeof comman_service_1.CommanService !== "undefined" && comman_service_1.CommanService) === "function" && _d || Object])
], ViewManufacturerComponent);
exports.ViewManufacturerComponent = ViewManufacturerComponent;
var _a, _b, _c, _d;
//# sourceMappingURL=/var/www/node_projects/angular2/efarm_admin/src/view-manufacturer.component.js.map
...
var routes = [
    {
        ...
        children: [
            {
                path: '',
                component: list_manufacturer_component_1.ListManufacturerComponent,
                data: {
                    title: 'List'
                }
            },
            ...
            {
                path: 'add',
                component: addupdate_manufacturer_component_1.AddUpdateManufacturerComponent,
                data: {
            ...
            {
                path: 'list/:id',
                component: view_manufacturer_component_1.ViewManufacturerComponent,
                data: {
                    title: 'View'
                }
            },
...
var ManufacturerRoutingModule = (function () {
    function ManufacturerRoutingModule() {
    }
    return ManufacturerRoutingModule;
}());
ManufacturerRoutingModule = __decorate([
    core_1.NgModule({
        imports: [
...
exports.ManufacturerRoutingModule = ManufacturerRoutingModule;
//# sourceMappingURL=/var/www/node_projects/angular2/efarm_admin/src/manufacturer-routing.module.js.map
...
module.exports = "<div>\r\n    <!-- loading section -->\r\n    <div class=\"aligncenter_loader\" *ngIf=\"isLoading\">\r\n        <div class=\"is-loading\"><i class=\"page-loader\"></i></div>\r\n    </div>\r\n    <!-- section ends  -->\r\n    <div class=\"card\" *ngIf=\"!isLoading\">\r\n        <div class=\"card-header\">\r\n            <div class=\"row\">\r\n                <div class=\"col-sm-6 col-12\">\r\n                    <strong>View Manufacturer</strong>\r\n                </div>\r\n                <div class=\"col-sm-6 col-12 text-right linehght\">\r\n                    <button type=\"button\" class=\"btn btn-secondary\" [routerLink]=\"['/manufacturer/list']\">Back</button>\r\n                    <button type=\"button\" class=\"btn btn-success pull-right\" (click)=\"editManufacturer(manufacturer.id)\">Edit Manufacturer</button>\r\n                    &nbsp;\r\n                </div>\r\n            </div>\r\n        </div>\r\n        <div class=\"card-block viewmode\">\r\n            <div class=\"row\">\r\n                <div class=\"col-sm-6\">\r\n                    <div class=\"form-group\">\r\n                        <label for=\"nf-name\">Name</label>\r\n                        <p>{{manufacturer.name}}</p>\r\n                    </div>\r\n                </div>\r\n                <div class=\"col-sm-6\">\r\n                    <div class=\"form-group\">\r\n                        <label for=\"nf-email\">Email</label>\r\n                        <p>{{manufacturer.email ? manufacturer.email : '-'}}</p>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n            <div class=\"row\">\r\n                <div class=\"col-sm-6\">\r\n                    <div class=\"form-group\">\r\n                        <label for=\"nf-mobile\">Mobile</label>\r\n                        <p>{{manufacturer.mobile ? manufacturer.mobile : '-'}}</p>\r\n                    </div>\r\n                </div>\r\n                <div class=\"col-sm-6\">\r\n                    <div class=\"form-group\">\r\n                        <label for=\"nf-description\">Description</label>\r\n                        <p>{{manufacturer.description ? manufacturer.description : '-'}}</p>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</div>\r\n"
